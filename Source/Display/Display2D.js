        ...
        class Display2D {
            ...
            drawArc(center, radiusInner, radiusOuter, angleStartInTurns, angleStopInTurns, colorFill, colorBorder) {
                ...
                if (colorFill != null) {
                    ...
                    drawPos.overwriteWith(center).add(new GameFramework.Polar(angleStopInTurns, radiusOuter, 0).toCoords(new GameFramework.Coords(0, 0, 0)));
            ...
            drawWedge(center, radius, angleStartInTurns, angleStopInTurns, colorFill, colorBorder) {
                ...
                if (colorFill != null) {
                    ...
                    drawPos.overwriteWith(center).add(new GameFramework.Polar(angleStopInTurns, radius, 0).toCoords(new GameFramework.Coords(0, 0, 0)));
                    this.graphics.lineTo(drawPos.x, drawPos.y);
