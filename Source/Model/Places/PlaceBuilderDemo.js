        ...
        class PlaceBuilderDemo // Main.
         {
            ...
            buildTunnels(size, placeNameToReturnTo) {
                ...
                var tunnelsEntity = new GameFramework.Entity("Tunnels", [
                    new GameFramework.Drawable(tunnelsVisual, null),
            ...
            buildZoned(size, placeNameToReturnTo) {
                ...
                var zonePosInZones = new GameFramework.Coords(0, 0, 0);
                var zoneSize = size;
                var neighborOffsets = [
                ...
                var boxZeroes = new GameFramework.Box(new GameFramework.Coords(0, 0, 0), new GameFramework.Coords(0, 0, 0));
                ...
                var posInZones = new GameFramework.Coords(0, 0, 0);
            ...
            buildTerrarium(size, placeNameToReturnTo) {
                ...
                var colorToTerrainVisualsByName = (colorName) => {
                    ...
                    var visualsByName = new Map([
                        ...
                        [
                            ...
                            new GameFramework.VisualGroup([
                                // n
                                new GameFramework.VisualOffset(new GameFramework.VisualRectangle(borderSizeHorizontalHalf, color, null, isCenteredFalse), new GameFramework.Coords(0, 0, 0)),
                                // w
                                new GameFramework.VisualOffset(new GameFramework.VisualRectangle(borderSizeVerticalHalf, color, null, isCenteredFalse), new GameFramework.Coords(0, 0, 0))
                            ])
                        ],
                        [
                            "InsideNE",
                        ...
                        [
                            "OutsideSE",
                            new GameFramework.VisualOffset(new GameFramework.VisualRectangle(borderSizeCorner, color, null, isCenteredFalse), new GameFramework.Coords(0, 0, 0))
                        ],
                        [
                            "OutsideSW",
                ...
                var terrainNameToVisuals = function (terrainName) {
                    ...
                    var tileOffsetInTilesHalf = new GameFramework.Coords(0, 0, 0);
                    var visualOffsetInMapCellsHalf = new GameFramework.Coords(0, 0, 0);
                ...
                var mapAndCellPosToEntity = (map, cellPosInCells) => {
                    ...
                    var cellAsEntity = new GameFramework.Entity(this.name + cellPosInCells.toString(), [
                        new GameFramework.Boundable(new GameFramework.Box(new GameFramework.Coords(0, 0, 0), //cellPosInPixels,
                        mapCellSize)),
                        cellCollidable.clone(),
                        new GameFramework.Drawable(cellVisual, null),
                        new GameFramework.DrawableCamera(),
                        new GameFramework.Locatable(new GameFramework.Disposition(cellPosInPixels, null, null)),
            ...
            entityBuildGoal(entities, entityDimension, entitySize, numberOfKeysToUnlockGoal) {
                ...
                var goalPos = new GameFramework.Coords(0, 0, 0).randomize(this.randomizer).multiplyScalar(.5).addDimensions(.25, .25, 0).multiply(this.size);
                ...
                var goalVisual = new GameFramework.VisualGroup([
                    new GameFramework.VisualRectangle(entitySize, goalColor, null, null),
                ...
                var goalEntity = new GameFramework.Entity("Goal", [
                    ...
                    new GameFramework.Collidable(0, new GameFramework.Box(new GameFramework.Coords(0, 0, 0), entitySize), null, null),
            ...
            entityBuildKeys(places, entityDimension, numberOfKeysToUnlockGoal, marginSize) {
                ...
                for (var i = 0; i < numberOfKeysToUnlockGoal; i++) {
                    var itemKeyPos = new GameFramework.Coords(0, 0, 0).randomize(this.randomizer).multiply(sizeMinusMargins).add(marginSize);
                    var itemKeyCollider = new GameFramework.Sphere(new GameFramework.Coords(0, 0, 0), entityDimensionHalf);
            ...
            entityBuildObstacleWalls(wallColor, areNeighborsConnectedESWN, placeNamePrefix, placePos, damagePerHit) {
                ...
                for (var i = 0; i < numberOfWalls; i++) {
                    ...
                    var wallCollider = new GameFramework.Box(new GameFramework.Coords(0, 0, 0), wallSize);
                    ...
                    for (var d = 0; d < numberOfWallPartsOnSide; d++) {
                        ...
                        var wallEntity = new GameFramework.Entity("ObstacleWall" + i + "_" + d, [
                            ...
                            wallCollidable,
                            new GameFramework.Drawable(wallVisual, null),
                            new GameFramework.DrawableCamera(),
                            wallObstacle
                        ]);
                        if (damagePerHit > 0) {
                    ...
                    if (isNeighborConnected) {
                        ...
                        var portalBox = new GameFramework.Box(new GameFramework.Coords(0, 0, 0), portalSize);
            ...
            entityDefnBuildStore(entityDimension) {
                ...
                var visual = new GameFramework.VisualGroup([
                    new GameFramework.VisualRectangle(new GameFramework.Coords(1, 1.5, 0).multiplyScalar(entityDimension), storeColor, null, null),
                    new GameFramework.VisualOffset(new GameFramework.VisualRectangle(new GameFramework.Coords(1.1, .2, 0).multiplyScalar(entityDimension), GameFramework.Color.byName("Gray"), null, null), new GameFramework.Coords(0, -.75, 0).multiplyScalar(entityDimension)),
                ]);
                if (this.visualsHaveText) {
            ...
            entityDefnBuildAccessory(entityDimension) {
                ...
                var itemAccessoryCollider = new GameFramework.Sphere(new GameFramework.Coords(0, 0, 0), entityDimensionHalf);
                var itemAccessoryEntityDefn = new GameFramework.Entity(itemDefnAccessoryName, [
                    new GameFramework.Item(itemDefnAccessoryName, 1),
                    new GameFramework.Locatable(null),
                    new GameFramework.Collidable(0, itemAccessoryCollider, null, null),
                    new GameFramework.Drawable(itemAccessoryVisual, null),
                    new GameFramework.DrawableCamera(),
                    new GameFramework.Equippable(null, null)
                ]);
            ...
            entityDefnBuildArmor(entityDimension) {
                ...
                var itemArmorCollider = new GameFramework.Sphere(new GameFramework.Coords(0, 0, 0), entityDimension / 2);
                var collidable = new GameFramework.Collidable(0, itemArmorCollider, null, null);
                var box = new GameFramework.Box(new GameFramework.Coords(0, 0, 0), new GameFramework.Coords(0, 0, 0)).ofPoints(path.points);
            ...
            entityDefnBuildArrow(entityDimension) {
                ...
                var itemArrowCollider = new GameFramework.Sphere(new GameFramework.Coords(0, 0, 0), entityDimensionHalf);
                ...
                var itemArrowEntityDefn = new GameFramework.Entity(itemDefnArrowName, [
                    boundable,
                    collidable,
                    new GameFramework.Drawable(itemArrowVisual, null),
                    new GameFramework.DrawableCamera(),
            ...
            entityDefnBuildBomb(entityDimension) {
                ...
                var itemBombCollider = new GameFramework.Sphere(new GameFramework.Coords(0, 0, 0), entityDimensionHalf);
                ...
                (u, w, p, entity) => // initialize
                ...
                }, (u, world, p, entityUser, entityDevice) => // use
                 {
                    ...
                    var projectileCollider = new GameFramework.Sphere(new GameFramework.Coords(0, 0, 0), projectileDimension);
                    // todo
                    ...
                    var projectileDie = (u, w, p, entityDying) => {
                        ...
                        var explosionCollider = new GameFramework.Sphere(new GameFramework.Coords(0, 0, 0), explosionRadius);
                        ...
                        var explosionEntity = new GameFramework.Entity("BombExplosion", [
                            ...
                            new GameFramework.Drawable(explosionVisual, null),
                            new GameFramework.DrawableCamera(),
                ...
                var itemBombEntityDefn = new GameFramework.Entity(itemDefnBombName, [
                    ...
                    new GameFramework.Locatable(null),
                    new GameFramework.Collidable(0, itemBombCollider, null, null),
                    itemBombDevice,
                    new GameFramework.Drawable(itemBombVisual, null),
                    new GameFramework.DrawableCamera(),
                    new GameFramework.Equippable(null, null)
                ]);
            ...
            entityDefnBuildBook(entityDimension) {
                ...
                var itemBookCollider = new GameFramework.Sphere(new GameFramework.Coords(0, 0, 0), entityDimensionHalf);
            ...
            entityDefnBuildBow(entityDimension) {
                ...
                var itemBowCollider = new GameFramework.Sphere(new GameFramework.Coords(0, 0, 0), entityDimension / 2);
                var itemBowUse = (u, world, p, entityUser, entityDevice) => // use
                 {
                    ...
                    var visualStrike = new GameFramework.VisualCircle(8, GameFramework.Color.byName("Red"), null, null);
                    ...
                    (universe, world, place, entityKillable) => // die
                     {
                        var entityStrike = new GameFramework.Entity("ArrowStrike", [
                            new GameFramework.Ephemeral(8, null),
                            new GameFramework.Drawable(visualStrike, null),
                            new GameFramework.DrawableCamera(),
                ...
                var itemBowEntityDefn = new GameFramework.Entity(itemDefnName, [
                    ...
                    new GameFramework.Locatable(null),
                    new GameFramework.Collidable(0, itemBowCollider, null, null),
                    new GameFramework.Drawable(itemBowVisual, null),
                    new GameFramework.DrawableCamera(),
                    new GameFramework.Equippable(null, null),
                    itemBowDevice
                ]);
            ...
            entityDefnBuildBread(entityDimension) {
                ...
                var itemBreadCollider = new GameFramework.Sphere(new GameFramework.Coords(0, 0, 0), entityDimensionHalf);
            ...
            entityDefnBuildCar(entityDimension) {
                ...
                var tilePosInTiles = new GameFramework.Coords(0, 0, 0);
                ...
                var carCollider = new GameFramework.Sphere(new GameFramework.Coords(0, 0, 0), entityDimension / 2);
                ...
                var carLoc = new GameFramework.Disposition(null, null, null);
                ...
                var carEntityDefn = new GameFramework.Entity(defnName, [
                    ...
                    carCollidable,
                    carConstrainable,
                    new GameFramework.Drawable(carVisual, null),
                    new GameFramework.DrawableCamera(),
                    carUsable,
                    vehicle
                ]);
            ...
            entityDefnBuildCoin(entityDimension) {
                ...
                var itemCoinCollider = new GameFramework.Sphere(new GameFramework.Coords(0, 0, 0), entityDimensionHalf);
            ...
            entityDefnBuildCrystal(entityDimension) {
                ...
                var itemCrystalCollider = new GameFramework.Sphere(new GameFramework.Coords(0, 0, 0), entityDimensionHalf);
            ...
            entityDefnBuildDoughnut(entityDimension) {
                ...
                var itemDoughnutCollider = new GameFramework.Sphere(new GameFramework.Coords(0, 0, 0), entityDimensionHalf);
            ...
            entityDefnBuildFlower(entityDimension) {
                ...
                var collider = new GameFramework.Sphere(new GameFramework.Coords(0, 0, 0), entityDimension);
            ...
            entityDefnBuildFruit(entityDimension) {
                ...
                var itemFruitCollider = new GameFramework.Sphere(new GameFramework.Coords(0, 0, 0), entityDimensionHalf);
            ...
            entityDefnBuildGrass(entityDimension) {
                ...
                var itemGrassCollider = new GameFramework.Sphere(new GameFramework.Coords(0, 0, 0), entityDimension / 2);
            ...
            entityDefnBuildHeart(entityDimension) {
                ...
                var itemHeartCollider = new GameFramework.Sphere(new GameFramework.Coords(0, 0, 0), entityDimensionHalf);
            ...
            entityDefnBuildIron(entityDimension) {
                ...
                var itemIronCollider = new GameFramework.Sphere(new GameFramework.Coords(0, 0, 0), entityDimensionHalf);
            ...
            entityDefnBuildIronOre(entityDimension) {
                ...
                var itemOreCollider = new GameFramework.Sphere(new GameFramework.Coords(0, 0, 0), entityDimensionHalf);
            ...
            entityDefnBuildLog(entityDimension) {
                ...
                var itemLogCollider = new GameFramework.Sphere(new GameFramework.Coords(0, 0, 0), entityDimensionHalf);
            ...
            entityDefnBuildMeat(entityDimension) {
                ...
                var itemMeatCollider = new GameFramework.Sphere(new GameFramework.Coords(0, 0, 0), entityDimensionHalf);
                var itemMeatEntityDefn = new GameFramework.Entity(itemDefnMeatName, [
                    new GameFramework.Item(itemDefnMeatName, 1),
                    new GameFramework.Locatable(null),
                    new GameFramework.Collidable(0, itemMeatCollider, null, null),
                    new GameFramework.Drawable(itemMeatVisual, null),
                    new GameFramework.DrawableCamera(),
            ...
            entityDefnBuildMedicine(entityDimension) {
                ...
                var itemMedicineCollider = new GameFramework.Sphere(new GameFramework.Coords(0, 0, 0), entityDimensionHalf);
                var itemMedicineEntityDefn = new GameFramework.Entity(itemDefnMedicineName, [
                    new GameFramework.Item(itemDefnMedicineName, 1),
                    new GameFramework.Locatable(null),
                    new GameFramework.Collidable(0, itemMedicineCollider, null, null),
                    new GameFramework.Drawable(itemMedicineVisual, null),
                    new GameFramework.DrawableCamera(),
                    new GameFramework.Equippable(null, null)
                ]);
            ...
            entityDefnBuildMushroom(entityDimension) {
                ...
                var itemMushroomCollider = new GameFramework.Sphere(new GameFramework.Coords(0, 0, 0), entityDimension / 2);
            ...
            entityDefnBuildPick(entityDimension) {
                ...
                var itemPickCollider = new GameFramework.Sphere(new GameFramework.Coords(0, 0, 0), entityDimension / 2);
                ...
                var itemPickEntityDefn = new GameFramework.Entity(itemDefnName, [
                    new GameFramework.Item(itemDefnName, 1),
                    new GameFramework.Locatable(null),
                    new GameFramework.Collidable(0, itemPickCollider, null, null),
                    itemPickDevice,
                    new GameFramework.Drawable(itemPickVisual, null),
                    new GameFramework.DrawableCamera(),
                    new GameFramework.Equippable(null, null)
                ]);
            ...
            entityDefnBuildPotion(entityDimension) {
                ...
                var itemPotionCollider = new GameFramework.Sphere(new GameFramework.Coords(0, 0, 0), entityDimensionHalf);
            ...
            entityDefnBuildShovel(entityDimension) {
                ...
                var itemShovelCollider = new GameFramework.Sphere(new GameFramework.Coords(0, 0, 0), entityDimension / 2);
                ...
                var itemShovelEntityDefn = new GameFramework.Entity(itemDefnName, [
                    new GameFramework.Item(itemDefnName, 1),
                    new GameFramework.Locatable(null),
                    new GameFramework.Collidable(0, itemShovelCollider, null, null),
                    itemShovelDevice,
                    new GameFramework.Drawable(itemShovelVisual, null),
                    new GameFramework.DrawableCamera(),
                    new GameFramework.Equippable(null, null)
                ]);
            ...
            entityDefnBuildSword(entityDimension, damageTypeName) {
                ...
                var itemSwordCollider = new GameFramework.Sphere(new GameFramework.Coords(0, 0, 0), entityDimension / 2);
                ...
                var itemSwordEntityDefn = new GameFramework.Entity(itemDefnName, [
                    new GameFramework.Item(itemDefnName, 1),
                    new GameFramework.Locatable(null),
                    new GameFramework.Collidable(0, itemSwordCollider, null, null),
                    new GameFramework.Drawable(itemSwordVisual, null),
                    new GameFramework.DrawableCamera(),
                    itemSwordDevice,
                    new GameFramework.Equippable(null, null)
                ]);
            ...
            entityDefnBuildToolset(entityDimension) {
                ...
                var itemToolsetCollider = new GameFramework.Sphere(new GameFramework.Coords(0, 0, 0), entityDimension / 2);
            ...
            entityDefnBuildTorch(entityDimension) {
                ...
                var itemTorchCollider = new GameFramework.Sphere(new GameFramework.Coords(0, 0, 0), entityDimension / 2);
            ...
            entityDefnBuildWeight(entityDimension) {
                ...
                var itemWeightCollider = new GameFramework.Sphere(new GameFramework.Coords(0, 0, 0), entityDimension / 2);
