...
class PlaceBuilderDemo {
    ...
    itemDefnsBuild(entityDimension) {
        ...
        var itemBookVisual = new VisualGroup([
            ...
            new VisualOffset(new VisualText(new DataBinding(itemBookName, null, null), itemBookColor, null), new Coords(0, 0 - entityDimension * 1.5, 0))
        ]);
        // coin
        var itemDefnCoinName = "Coin";
        ...
        var itemFlowerVisual = new VisualGroup([
            ...
            "Green", null), new Coords(.5, 1.75, 0).multiplyScalar(entityDimensionHalf)),
            new VisualPolygon(new Path([
                new Coords(1, 0, 0),
                new Coords(.3, .3, 0),
                new Coords(0, 1, 0),
        ...
        var itemGrassVisual = new VisualGroup([
            ...
            new VisualOffset(new VisualText(new DataBinding(itemNameGrass, null, null), "Green", null), new Coords(0, 0 - entityDimensionHalf * 3, 0))
        ]);
        // gun
        var itemGunName = "Gun";
        ...
        var itemGunVisual = new VisualGroup([
            ...
            null),
            new VisualOffset(new VisualText(new DataBinding(itemGunName, null, null), itemGunColor, null), new Coords(0, 0 - entityDimension, 0))
        ]);
        // key
        var itemKeyName = "Key";
        var itemKeyColor = "Yellow";
        ...
        var itemMedicineVisual = new VisualGroup([
            new VisualRectangle(new Coords(1, 1, 0).multiplyScalar(entityDimension), "White", null, null),
            new VisualPolygon(new Path([
        ...
        var itemMushroomVisual = new VisualGroup([
            ...
            new VisualOffset(new VisualText(new DataBinding(itemMushroomName, null, null), colorCap, null), new Coords(0, 0 - entityDimensionHalf * 3, 0))
        ]);
        // ore
        var itemOreName = "Ore";
        ...
        var itemOreVisual = new VisualGroup([
            ...
            .5, // angleSpannedInTurns
            itemOreColor, null),
            new VisualOffset(new VisualText(new DataBinding(itemOreName, null, null), itemOreColor, null), new Coords(0, 0 - entityDimension * 1.5, 0))
        ]);
        // pick
        var itemPickName = "Pick";
        var itemPickColor = "Gray";
        var itemPickVisual = new VisualGroup([
            new VisualOffset(new VisualRectangle(new Coords(entityDimension / 4, entityDimension, 0), "Brown", null, null), new Coords(0, 0 - entityDimension / 2, 0)),
            new VisualPolygon(new Path([
                new Coords(0.75, -1, 0),
                new Coords(-0.75, -1, 0),
        ...
        var itemToolsetVisual = new VisualGroup([
            ...
            new VisualOffset(new VisualText(new DataBinding(itemToolsetName, null, null), itemToolsetColor, null), new Coords(0, 0 - entityDimension, 0))
        ]);
        var itemDefns = [
