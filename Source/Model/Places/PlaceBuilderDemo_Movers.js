        ...
        class PlaceBuilderDemo_Movers {
            ...
            entityDefnBuildPlayer(entityDimension, displaySize) {
                ...
                var playerCollide = (universe, world, place, entityPlayer, entityOther) => {
                    ...
                    if (entityOtherDamager != null) {
                        ...
                        if (entityPlayer.itemHolder().hasItem(keysRequired)) {
                            var venueMessage = new GameFramework.VenueMessage(new GameFramework.DataBinding("You win!", null, null), (universe) => // acknowledge
                             {
                                universe.venueNext = new GameFramework.VenueFader(new GameFramework.VenueControls(universe.controlBuilder.title(universe, null), false), null, null, null);
                ...
                (universe, world, place, entityDamager, entityKillable, damage) => // damageApply
                 ...
                 {
                    var venueMessage = new GameFramework.VenueMessage(new GameFramework.DataBinding("You lose!", null, null), (universe) => // acknowledge
                     {
                        universe.venueNext = new GameFramework.VenueFader(new GameFramework.VenueControls(universe.controlBuilder.title(universe, null), false), null, null, null);
                    }, universe.venueCurrent, // venuePrev
                    universe.display.sizeDefault().clone(), //.half(),
