...
class PlaceBuilderDemo_Movers {
        ...
        var playerActivityPerform = (universe, world, place, entityPlayer, activity) => {
            ...
            if (inputHelper.isMouseClicked(null)) {
                ...
                var entityToSelect = entitiesInPlace.filter(x => (selector.entitiesSelected.indexOf(x) == -1
                    && x.locatable().distanceFromPos(mousePos) < range)).sort((a, b) => a.locatable().distanceFromPos(mousePos)
                    - b.locatable().distanceFromPos(mousePos))[0];
    ...
    entityDefnBuildPlayer_Controllable() {
        var toControlMenu = this.entityDefnBuildPlayer_Controllable_toControlMenu;
        var toControlWorldOverlay = this.entityDefnBuildPlayer_Controllable_toControlWorldOverlay;
    ...
    entityDefnBuildPlayer_Controllable_toControlMenu(universe, size, entity, venuePrev) {
        var fontHeight = 12;
    ...
    entityDefnBuildPlayer_Controllable_toControlWorldOverlay(universe, size, entity) {
