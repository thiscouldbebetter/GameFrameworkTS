class PlaceBuilderDemo_Movers
{
	...
	{
		var toControlMenu =
			this.entityDefnBuildPlayer_Controllable_toControlMenu;
		var toControlWorldOverlay =
			this.entityDefnBuildPlayer_Controllable_toControlWorldOverlay;
	...
	entityDefnBuildPlayer_Controllable_toControlMenu(universe: Universe, size: Coords, entity: Entity, venuePrev: Venue)
	{
		var fontHeight = 12;
	...
	entityDefnBuildPlayer_Controllable_toControlWorldOverlay(universe: Universe, size: Coords, entity: Entity)
	{
