        ...
        class JournalKeeper extends GameFramework.EntityPropertyBase {
            ...
            toControl(universe, size, entityJournalKeeper, venuePrev, includeTitleAndDoneButton) {
                ...
                var childControls = [
                    ...
                    GameFramework.ControlButton.fromPosSizeTextFontClick(Coords.fromXY(65, 5), // pos
                    ...
                    new GameFramework.ControlList("listEntries", Coords.fromXY(10, 15), // pos
                    ...
                    GameFramework.ControlButton.fromPosSizeTextFontClick(Coords.fromXY(146, 5), // pos
                    ...
                    GameFramework.ControlButton.fromPosSizeTextFontClick(Coords.fromXY(164, 5), // pos
                    Coords.fromXY(15, 8), // size
                    "Edit", fontSmall, entrySelectedEdit).isEnabledSet(GameFramework.DataBinding.fromContextAndGet(this, (c) => (c.journalEntrySelected != null
                        && c.isJournalEntrySelectedEditable == false))),
                    GameFramework.ControlButton.fromPosSizeTextFontClick(Coords.fromXY(182, 5), // pos
                    ...
                    GameFramework.ControlLabel.fromPosSizeTextFontUncentered(Coords.fromXY(105, 15), // pos
                    Coords.fromXY(100, 15), // size
                    GameFramework.DataBinding.fromContext("Time Recorded:"), fontSmall),
                    GameFramework.ControlLabel.fromPosSizeTextFontUncentered(Coords.fromXY(145, 15), // pos
                    Coords.fromXY(100, 15), // size
                    ...
                    new GameFramework.ControlTextBox("textTitle", Coords.fromXY(105, 25), // pos
                    ...
                    new GameFramework.ControlTextarea("textareaEntryBody", Coords.fromXY(105, 40), // pos
                    ...
                    GameFramework.ControlLabel.fromPosSizeTextFontCenteredHorizontally(Coords.fromXY(150, 120), // pos
                    null, // size
                    GameFramework.DataBinding.fromContextAndGet(this, (c) => {
                ...
                var returnValue = GameFramework.ControlContainer.fromNamePosSizeChildrenActionsAndMappings("Notes", Coords.create(), // pos
                sizeBase.clone(), // size
                childControls, [
