...
class Action_Instances {
    constructor() {
        ...
        this.ShowItems = new Action("ShowItems", (universe, world, place, actor) => // perform
         {
            var control = actor.controllable().toControl(universe, universe.display.sizeInPixels, actor, universe.venueCurrent);
        ...
        this.ShowMenu = new Action("ShowMenu", (universe, world, place, actor) => // perform
         {
            var venueNext = new VenueControls(universe.controlBuilder.gameAndSettings(universe, null));
            venueNext = new VenueFader(venueNext, universe.venueCurrent, null, null);
            universe.venueNext = venueNext;
        });
    }
