...
class PlaceBuilderDemo {
    ...
    build_SizeWallsAndMargins(namePrefix, placePos, areNeighborsConnectedESWN) {
        ...
        var wallThickness = this.entityBuildObstacleWalls("Red", areNeighborsConnectedESWN, namePrefix, placePos);
    ...
    entityBuildBackground(camera) {
        ...
        new VisualRectangle(visualBackgroundCellSize, null, "rgba(255, 255, 255, 0.02)", null), true // expandViewStartAndEndByCell
        );
        ...
        new VisualRectangle(visualBackgroundCellSize, null, "rgba(255, 255, 255, 0.06)", null), true // expandViewStartAndEndByCell
        );
    ...
    entityBuildGoal(entities, entityDimension, entitySize, numberOfKeysToUnlockGoal) {
        ...
        var goalEntity = new Entity("Goal", [
            ...
            new Drawable(new VisualGroup([
                ...
                new VisualText(new DataBinding("" + numberOfKeysToUnlockGoal, null, null), itemKeyColor, null),
                new VisualOffset(new VisualText(new DataBinding("Exit", null, null), goalColor, null), new Coords(0, 0 - entityDimension * 2, 0))
            ]), null),
            new DrawableCamera(),
    ...
    entityBuildKeys(places, entityDimension, numberOfKeysToUnlockGoal, marginSize) {
        ...
        var itemKeyVisual = new VisualGroup([
            ...
            new VisualOffset(new VisualText(new DataBinding(itemDefnKeyName, null, null), itemKeyColor, null), new Coords(0, 0 - entityDimension * 2, 0))
        ]);
        ...
        for (var i = 0; i < numberOfWalls; i++) {
            ...
            if (isNeighborConnected) {
                ...
                var portalEntity = new Entity("PortalToNeighbor" + i, [
                    ...
                    new Drawable(new VisualRectangle(portalSize, "Violet", null, null), null),
                    new DrawableCamera()
                ]);
    ...
    entityDefnBuildStore(entityDimension) {
        ...
        var storeEntityDefn = new Entity("Store", [
            ...
            new Drawable(new VisualGroup([
                ...
                new VisualOffset(new VisualRectangle(new Coords(1.1, .2, 0).multiplyScalar(entityDimension), "Gray", null, null), new Coords(0, -.75, 0).multiplyScalar(entityDimension)),
                new VisualOffset(new VisualText(new DataBinding("Store", null, null), storeColor, null), new Coords(0, 0 - entityDimension * 2, 0))
            ]), null),
            new DrawableCamera(),
            new ItemStore("Coin"),
    ...
    entityDefnBuildAccessory(entityDimension) {
        ...
        var itemAccessoryVisual = new VisualGroup([
            ...
            new VisualOffset(new VisualText(new DataBinding(itemDefnAccessoryName, null, null), itemAccessoryColor, null), new Coords(0, 0 - entityDimension * 2, 0))
        ]);
    ...
    entityDefnBuildBook(entityDimension) {
        ...
        var itemBookVisual = new VisualGroup([
            ...
            new VisualOffset(new VisualRectangle(new Coords(.1, 1.1, 0).multiplyScalar(entityDimension), "White", null, null), new Coords(.4, 0, 0).multiplyScalar(entityDimension)),
            new VisualOffset(new VisualText(new DataBinding(itemDefnBookName, null, null), itemBookColor, null), new Coords(0, 0 - entityDimension * 1.5, 0))
        ]);
    ...
    entityDefnBuildContainer(entityDimension) {
        ...
        var visual = new VisualGroup([
            ...
            new VisualRectangle(new Coords(1.5 * entityDimension, 1, 0), "Gray", null, null),
            new VisualRectangle(new Coords(.5, .5, 0).multiplyScalar(entityDimension), "Gray", null, null),
            new VisualOffset(new VisualText(new DataBinding("Container", null, null), containerColor, null), new Coords(0, 0 - entityDimension, 0))
        ]);
    ...
    entityDefnBuildCrystal(entityDimension) {
        ...
        var itemCrystalVisual = new VisualGroup([
            ...
            new VisualOffset(new VisualText(new DataBinding(itemDefnCrystalName, null, null), itemCrystalColor, null), new Coords(0, 0 - entityDimension, 0))
        ]);
    ...
    entityDefnBuildFlower(entityDimension) {
        ...
        var color = "Pink";
        var visual = new VisualGroup([
            new VisualOffset(new VisualArc(entityDimension * 2, // radiusOuter
            entityDimension * 2 - 2, // radiusInner
            new Coords(-1, 1, 0).normalize(), // directionMin
            .25, // angleSpannedInTurns
            "Green", null), new Coords(.5, 1.75, 0).multiplyScalar(entityDimension)),
            new VisualPolygon(new Path([
                new Coords(1, 0, 0),
                new Coords(.3, .3, 0),
                new Coords(0, 1, 0),
                ...
                new Coords(0, -1, 0),
                new Coords(.3, -.3, 0)
            ]).transform(new Transform_Scale(new Coords(1, 1, 1).multiplyScalar(entityDimension))), color, "Red"),
            new VisualOffset(new VisualText(new DataBinding(itemDefnName, null, null), color, null), new Coords(0, 0 - entityDimension * 2, 0))
        ]);
    ...
    entityDefnBuildGenerator(entityDefnToGenerate) {
        var generator = new Generator(entityDefnToGenerate, 1000, // ticksToGenerate
    ...
    entityDefnBuildGun(entityDimension) {
        ...
        var itemWeaponVisual = new VisualGroup([
            new VisualPath(new Path([
                ...
                new Coords(-0.3, -0.2, 0),
                new Coords(0.3, -0.2, 0)
            ]).transform(Transform_Scale.fromScalar(entityDimension)), itemWeaponColor, 5, // lineThickness
            null),
            new VisualOffset(new VisualText(new DataBinding(itemDefnName, null, null), itemWeaponColor, null), new Coords(0, 0 - entityDimension, 0))
        ]);
        var itemWeaponCollider = new Sphere(new Coords(0, 0, 0), entityDimension / 2);
        var itemWeaponDevice = Device.gun();
        var itemWeaponEntityDefn = new Entity(itemDefnName, [
            new Item(itemDefnName, 1),
            new Locatable(new Disposition(new Coords(0, 0, 0), null, null)),
    ...
    entityDefnBuildMaterial(entityDimension) {
        ...
        var itemMaterialVisual = new VisualGroup([
            ...
            new VisualOffset(new VisualText(new DataBinding(itemDefnMaterialName, null, null), itemMaterialColor, null), new Coords(0, 0 - entityDimension, 0))
        ]);
    ...
    entityDefnBuildMeat(entityDimension) {
        ...
        var itemMeatVisual = new VisualGroup([
            ...
            new VisualCircle(entityDimensionHalf * .75, null, "Gray"),
            new VisualOffset(new VisualText(new DataBinding(itemDefnMeatName, null, null), itemMeatColor, null), new Coords(0, 0 - entityDimension, 0))
        ]);
    ...
    entityDefnBuildMedicine(entityDimension) {
        ...
        var itemMedicineVisual = new VisualGroup([
            ...
            new VisualOffset(new VisualText(new DataBinding(itemDefnMedicineName, null, null), itemMedicineColor, null), new Coords(0, 0 - entityDimension, 0))
        ]);
    ...
    entityDefnBuildMushroom(entityDimension) {
        ...
        var itemMushroomVisual = new VisualGroup([
            new VisualOffset(new VisualArc(entityDimension, // radiusOuter
            0, // radiusInner
            new Coords(-1, 0, 0), // directionMin
            .5, // angleSpannedInTurns
            colorCap, null), new Coords(0, -entityDimension / 2, 0)),
            new VisualOffset(new VisualRectangle(new Coords(entityDimension / 2, entityDimension, 0), colorStem, null, null), new Coords(0, 0, 0)),
            new VisualOffset(new VisualText(new DataBinding(itemDefnName, null, null), colorCap, null), new Coords(0, 0 - entityDimension * 3, 0))
        ]);
    ...
    entityDefnBuildObstacleBar(entityDimension) {
        ...
        var visual = new VisualRotate(obstacleRotationInTurns, new VisualGroup([
            ...
            new VisualOffset(new VisualText(new DataBinding("Bar", null, null), obstacleColor, null), new Coords(0, 0 - obstacleCollider.box.size.y, 0))
        ]));
    ...
    entityDefnBuildObstacleMine(entityDimension) {
        ...
        var obstacleMappedVisual = new VisualGroup([
            ...
            new VisualOffset(new VisualText(new DataBinding("Mine", null, null), obstacleColor, null), new Coords(0, 0 - entityDimension * 2, 0))
        ]);
    ...
    entityDefnBuildSword(entityDimension) {
        ...
        var itemWeaponColor = "rgb(0, 128, 128)";
        var itemWeaponVisual = new VisualGroup([
            new VisualPolygonLocated(new Path([
                new Coords(0.2, 0.5, 0),
                new Coords(0.2, 0.2, 0),
                new Coords(2, 0.2, 0),
                new Coords(2.3, 0, 0),
                ...
                new Coords(-0.2, 0.2, 0),
                new Coords(-0.2, 0.5, 0)
            ]).transform(Transform_Scale.fromScalar(entityDimension)), itemWeaponColor, itemWeaponColor),
            new VisualOffset(new VisualText(new DataBinding(itemDefnName, null, null), itemWeaponColor, null), new Coords(0, 0 - entityDimension, 0))
        ]);
        var itemWeaponCollider = new Sphere(new Coords(0, 0, 0), entityDimension / 2);
    ...
    entityDefnBuildToolset(entityDimension) {
        ...
        var itemToolsetVisual = new VisualGroup([
            new VisualOffset(new VisualRectangle(new Coords(entityDimension / 4, entityDimension, 0), "Brown", null, null), new Coords(0, entityDimension / 2, 0)),
            new VisualRectangle(new Coords(entityDimension, entityDimension / 2, 0), itemToolsetColor, null, null),
            new VisualOffset(new VisualText(new DataBinding(itemDefnName, null, null), itemToolsetColor, null), new Coords(0, 0 - entityDimension, 0))
        ]);
    ...
    entityDefnBuildTree(entityDimension) {
        ...
        var color = "Green";
        var visual = new VisualGroup([
            new VisualRectangle(new Coords(1, 2, 0).multiplyScalar(entityDimension * 0.5), "Brown", null, null),
            ...
            new VisualOffset(new VisualText(new DataBinding(entityName, null, null), color, null), new Coords(0, 0 - entityDimension * 2, 0))
        ]);
