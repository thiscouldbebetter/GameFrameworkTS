...
class ControlList {
    ...
    static fromPosSizeAndItems(pos, size, items) {
        ...
        pos, size, items, new DataBinding(null, null, null), // bindingForItemText,
    ...
    itemSelected(itemToSet) {
        ...
        if (itemToSet == null) {
            ...
            if (this.bindingForItemSelected != null) {
                var valueToSet = this.bindingForItemValue.contextSet(this._itemSelected).get();
    ...
    itemSelectedNextInDirection(direction) {
        ...
        if (indexOfItemSelected == null) {
            ...
            indexOfItemSelected = NumberHelper.trimToRangeMinMax(indexOfItemSelected + direction, 0, numberOfItems - 1);
        }
