...
class ControlBuilder {
    ...
    game(universe, size) {
        ...
        [
            ...
            () => // click
             {
                var venueNext = new VenueControls(universe.controlBuilder.worldSave(universe, null));
                venueNext = new VenueFader(venueNext, universe.venueCurrent, null, null);
                universe.venueNext = venueNext;
            }, null, null),
    ...
    gameAndSettings(universe, size) {
        ...
        var returnValue = new ControlContainer("containerGameAndSettings", this._zeroes, // pos
        this.sizeBase.clone(), 
        // children
        [
            new ControlButton("buttonGame", new Coords(70, row1PosY, 0), // pos
            ...
            new ControlButton("buttonSettings", new Coords(70, row2PosY, 0), // pos
            new Coords(60, buttonHeight, 0), // size
            ...
            new ControlButton("buttonResume", new Coords(70, row3PosY, 0), // pos
            new Coords(60, buttonHeight, 0), // size
    ...
    inputs(universe, size, venuePrev) {
        ...
        [
            ...
            () => {
                ...
                var controlConfirm = universe.controlBuilder.confirm(universe, size, "Are you sure you want to restore defaults?", () => // confirm
                 {
    ...
    profileDetail(universe, size) {
        ...
        var scaleMultiplier = this._scaleMultiplier.overwriteWith(size).divide(this.sizeBase);
        var fontHeight = this.fontHeightInPixelsBase;
        var returnValue = new ControlContainer("containerProfileDetail", this._zeroes, // pos
        this.sizeBase.clone(), // size
        // children
        [
            ...
            () => // click
             {
                ...
                universe.profileHelper.profileSave(profile);
                universe.world = world;
                var venueNext = new VenueControls(universe.controlBuilder.worldDetail(universe, size));
                venueNext = new VenueFader(venueNext, universe.venueCurrent, null, null);
                universe.venueNext = venueNext;
            }, null, null),
            new ControlButton("buttonSelect", new Coords(105, 110, 0), // pos
            new Coords(45, 25, 0), // size
            "Select", fontHeight, true, // hasBorder
            // isEnabled
            new DataBinding(universe.profile, (c) => (c.worldSelected != null), null), () => // click
             {
            ...
            () => // click
             {
                var venueNext = new VenueControls(universe.controlBuilder.profileSelect(universe, size));
                venueNext = new VenueFader(venueNext, universe.venueCurrent, null, null);
                universe.venueNext = venueNext;
            }, null, null),
            ...
            () => // click
             {
                ...
                var controlConfirm = universe.controlBuilder.confirm(universe, size, "Delete profile \""
                 ...
                 {
                    var profile = universe.profile;
                    universe.profileHelper.profileDelete(profile);
                    var venueNext = new VenueControls(universe.controlBuilder.profileSelect(universe, null));
                    venueNext = new VenueFader(venueNext, universe.venueCurrent, null, null);
                    universe.venueNext = venueNext;
                }, () => // cancel
                 {
                    var venueNext = new VenueControls(universe.controlBuilder.profileDetail(universe, size));
                    venueNext = new VenueFader(venueNext, universe.venueCurrent, null, null);
                    universe.venueNext = venueNext;
                });
                var venueNext = new VenueControls(controlConfirm);
    ...
    profileNew(universe, size) {
        ...
        var scaleMultiplier = this._scaleMultiplier.overwriteWith(size).divide(this.sizeBase);
        var fontHeight = this.fontHeightInPixelsBase;
        var returnValue = new ControlContainer("containerProfileNew", this._zeroes, // pos
        this.sizeBase.clone(), // size
        // children
        [
            ...
            new DataBinding(universe.profile, (c) => { return c.name.length > 0; }, null), () => // click
             {
                ...
                universe.profileHelper.profileAdd(profile);
    ...
    profileSelect(universe, size) {
        ...
        var returnValue = new ControlContainer("containerProfileSelect", this._zeroes, // pos
        this.sizeBase.clone(), // size
        // children
        [
            ...
            () => // click
             {
                ...
                var venueNext = new VenueControls(universe.controlBuilder.profileNew(universe, null));
                venueNext = new VenueFader(venueNext, universe.venueCurrent, null, null);
                universe.venueNext = venueNext;
            }, null, null),
            new ControlButton("buttonSelect", new Coords(80, 95, 0), // pos
            new Coords(40, 25, 0), // size
            "Select", fontHeight, true, // hasBorder
            // isEnabled
            new DataBinding(universe, (c) => { return (c.profile != null); }, null), () => // click
             {
                var venueControls = universe.venueCurrent;
                var controlRootAsContainer = venueControls.controlRoot;
            ...
            new ControlButton("buttonSkip", new Coords(125, 95, 0), // pos
            new Coords(40, 25, 0), // size
            ...
            () => // click
             {
                var controlConfirm = universe.controlBuilder.confirm(universe, size, "Delete all profiles?", () => // confirm
                 {
    ...
    settings(universe, size) {
        ...
        [
            ...
            "Music:", fontHeight),
            new ControlSelect("selectMusicVolume", new Coords(65, row1PosY, 0), // pos
            ...
            () => // click
             {
                ...
                var controlConfirm = universe.controlBuilder.confirm(universe, size, "Delete world \""
                 ...
                 {
                    var venueNext = new VenueControls(universe.controlBuilder.worldDetail(universe, null));
                    venueNext = new VenueFader(venueNext, universe.venueCurrent, null, null);
                    universe.venueNext = venueNext;
                });
                var venueNext = new VenueControls(controlConfirm);
    ...
    worldLoad(universe, size) {
        ...
        var confirm = () => {
            ...
            if (worldToReload == null) {
                venueNext = new VenueControls(universe.controlBuilder.message(universe, size, new DataBinding("No save exists to reload!", null, null), () => // acknowledge
                 {
                    var venueNext = new VenueControls(universe.controlBuilder.worldLoad(universe, null));
                    venueNext = new VenueFader(venueNext, universe.venueCurrent, null, null);
                    universe.venueNext = venueNext;
                ...
                var venueMessageReadyToLoad = new VenueControls(universe.controlBuilder.message(universe, size, new DataBinding("Ready to load from file...", null, null), () => // acknowledge
                 {
                    ...
                    new FileHelper().loadFileAsText(fileToLoad, callback, null // contextForCallback
                    );
                }, null));
    ...
    worldSave(universe, size) {
        ...
        var handleSaveToLocalStorage = (wasSaveSuccessful) => {
            var message = (wasSaveSuccessful ? "Profile saved successfully." : "Save failed due to errors.");
            var venueNext = new VenueControls(universe.controlBuilder.message(universe, size, new DataBinding(message, null, null), () => // acknowledge
             {
                var venueNext = new VenueControls(universe.controlBuilder.game(universe, null));
                venueNext = new VenueFader(venueNext, universe.venueCurrent, null, null);
                universe.venueNext = venueNext;
            }, false));
            venueNext = new VenueFader(venueNext, universe.venueCurrent, null, null);
        ...
        var saveToLocalStorage = () => {
            ...
            (c) => "Building record of game...", null);
            var venueMessage = new VenueMessage(messageAsDataBinding, null, null, null, null);
            ...
            var venueTask = new VenueTask(venueMessage, () => // perform
             {
                ...
                wasSaveSuccessful = universe.profileHelper.profileSave(profile);
        ...
        var saveToFilesystem = () => {
            ...
            var venueTask = new VenueTask(venueMessage, () => // perform
            ...
            }, (universe, worldSerialized) => // done
             {
                ...
                new FileHelper().saveTextStringToFileWithName(worldSerialized, universe.world.name + ".json");
                var venueMessage = new VenueControls(universe.controlBuilder.message(universe, size, new DataBinding(message, null, null), () => // acknowledge
                 {
                    var venueNext = new VenueControls(universe.controlBuilder.game(universe, null));
                    venueNext = new VenueFader(venueNext, universe.venueCurrent, null, null);
                    universe.venueNext = venueNext;
        ...
        var returnValue = new ControlContainer("containerSave", this._zeroes, // pos
        this.sizeBase.clone(), // size
        // children
        [
            new ControlButton("buttonSaveToLocalStorage", new Coords(30, 15, 0), // pos
            new Coords(140, 25, 0), // size
            "Save to Local Storage", fontHeight, true, // hasBorder
            true, // isEnabled
            saveToLocalStorage, null, null),
            new ControlButton("buttonSaveToFile", new Coords(30, 50, 0), // pos
            new Coords(140, 25, 0), // size
            "Save to File", fontHeight, true, // hasBorder
            true, // isEnabled
