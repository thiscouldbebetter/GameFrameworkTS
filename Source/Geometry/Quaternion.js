    ...
    (function (GameFramework) {
        class Quaternion {
            ...
            transformCoordsAsRotation(coordsToRotate) {
                ...
                this.clone().multiply(coordsToRotateAsQuaternion).multiply(this.clone().invert()).toCoords(coordsToRotate);
            ...
            magnitude() {
                return Math.sqrt(this.w * this.w
                    + this.x * this.x
                    + this.y * this.y
                    + this.z * this.z);
            }
        ...
        GameFramework.Quaternion = Quaternion;
