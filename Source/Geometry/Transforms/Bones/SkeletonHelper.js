...
class SkeletonHelper {
    static biped(heightInPixels) {
        ...
        var upperEntity = new Bone("Spine.1", heightOfSpine, new Orientation(new Coords(0, 0, -1), new Coords(0, -1, 0)), [
            new Bone("Neck", heightOver12, new Orientation(new Coords(0, 0, -1), new Coords(0, 1, 0)), [
                new Bone("Head.Back", heightOver18, new Orientation(new Coords(0, 0, -1), new Coords(0, 1, 0)), [
                    new Bone("Head.Front", heightOver9, new Orientation(new Coords(0, 1, 0), new Coords(0, 0, 1)), [], isVisibleTrue),
                ], isVisibleTrue)
            ], isVisibleTrue),
    ...
    static bipedAnimationDefnDoSomething() {
        var returnValue = new AnimationDefn("DoSomething", [
            ...
            new AnimationKeyframe(1, new Array(new Transform_BonePose("Forearm.L", [.25]), new Transform_BonePose("Bicep.L", [.25, 0, .25]), new Transform_BonePose("Forearm.R", [.25]), new Transform_BonePose("Bicep.R", [.25, 0, -.25]))),
        ]);
        return returnValue;
    }
    static bipedAnimationDefnJump() {
        var returnValue = new AnimationDefn("Jump", [
            ...
            new AnimationKeyframe(1, new Array(new Transform_BonePose("Thigh.L", [.25]), new Transform_BonePose("Shin.L", [.25]), new Transform_BonePose("Thigh.R", [.25]), new Transform_BonePose("Shin.R", [.25]))),
        ]);
        return returnValue;
    }
    ;
    static bipedAnimationDefnWalk() {
        var animationDefnBipedWalk = new AnimationDefn("Walk", [
            new AnimationKeyframe(0, new Array(new Transform_BonePose("Bicep.L", [-.1]), new Transform_BonePose("Forearm.L", [0]), new Transform_BonePose("Thigh.L", [.1]), new Transform_BonePose("Shin.L", [0]), new Transform_BonePose("Bicep.R", [.1]), new Transform_BonePose("Forearm.R", [.1]), new Transform_BonePose("Thigh.R", [-.05]), new Transform_BonePose("Shin.R", [0]))),
            new AnimationKeyframe(5, new Array(new Transform_BonePose("Thigh.L", [.1]), new Transform_BonePose("Shin.L", [.1]), new Transform_BonePose("Thigh.R", [-.1]), new Transform_BonePose("Shin.R", [0]))),
            new AnimationKeyframe(10, new Array(new Transform_BonePose("Thigh.L", [0]), new Transform_BonePose("Shin.L", [0]), new Transform_BonePose("Thigh.R", [0]), new Transform_BonePose("Shin.R", [.1]))),
            new AnimationKeyframe(15, new Array(new Transform_BonePose("Bicep.L", [.1]), new Transform_BonePose("Forearm.L", [.1]), new Transform_BonePose("Thigh.L", [-.05]), new Transform_BonePose("Bicep.R", [-.1]), new Transform_BonePose("Forearm.R", [0]), new Transform_BonePose("Thigh.R", [.1]), new Transform_BonePose("Shin.R", [0]))),
            new AnimationKeyframe(20, new Array(new Transform_BonePose("Thigh.L", [-.1]), new Transform_BonePose("Shin.L", [0]), new Transform_BonePose("Thigh.R", [.1]), new Transform_BonePose("Shin.R", [.1]))),
            new AnimationKeyframe(25, new Array(new Transform_BonePose("Thigh.L", [0]), new Transform_BonePose("Shin.L", [.1]), new Transform_BonePose("Thigh.R", [0]), new Transform_BonePose("Shin.R", [0]))),
            new AnimationKeyframe(30, new Array(new Transform_BonePose("Bicep.L", [-.1]), new Transform_BonePose("Forearm.L", [0]), new Transform_BonePose("Thigh.L", [.1]), new Transform_BonePose("Shin.L", [0]), new Transform_BonePose("Bicep.R", [.1]), new Transform_BonePose("Forearm.R", [.1]), new Transform_BonePose("Thigh.R", [-.05]), new Transform_BonePose("Shin.R", [0]))),
        ]);
    ...
    static transformBuildForMeshAndSkeleton_Proximity(meshAtRest, skeletonAtRest, skeletonPosed) {
        ...
        for (var v = 0; v < vertices.length; v++) {
            ...
            if (boneInfluence == null) {
                boneInfluence = new BoneInfluence(boneClosestName, new Array());
