...
class LandscapeMap {
    constructor(name, depthMax, terrainSet) {
        ...
        this.sizeInCellsMinusOnes = this.sizeInCells.clone().add(new Coords(-1, -1, 0));
        this.cellAltitudes = [];
    }
    ...
    generateRandom() {
        var cornerCellPositions = [
            new Coords(0, 0, 0),
            new Coords(this.sizeInCellsMinusOnes.x, 0, 0),
            new Coords(this.sizeInCellsMinusOnes.x, this.sizeInCellsMinusOnes.y, 0),
            new Coords(0, this.sizeInCellsMinusOnes.y, 0),
        ];
    ...
    generateRandom_2(parentPos, childPos, neighborDatas, stepSizeInCells, stepSizeInCellsHalf, altitudeVariationRange) {
        ...
        for (var n = 0; n < neighborDatas.length; n++) {
            ...
            if (childPos.isInRangeMax(this.sizeInCellsMinusOnes)) {
                ...
                childAltitude = NumberHelper.reflectNumberOffRange(childAltitude, 0, 1);
