...
class MeshBuilder {
    biped(material, heightInPixels) {
        ...
        var meshesForEntityParts = [
            this.box(
            //"Pelvis",
            material, new Coords(heightOver12, heightOver24, heightOver24), new Coords(0, 0, -heightOver2)),
            this.box(
            //"Spine.1",
            material, new Coords(heightOver12, heightOver24, heightOver6), new Coords(0, 0, 0 - heightOver2 - heightOver4)),
            this.box(
            //"Head",
            material, new Coords(heightOver18, heightOver18, heightOver18), new Coords(0, heightOver36, 0 - heightInPixels)),
            this.box(
            //"Thigh.L",
            material, new Coords(heightOver36, heightOver36, heightOver8), new Coords(heightOver18, 0, 0 - heightOver2 + heightOver12)),
            this.box(
            //"Shin.L",
            material, new Coords(heightOver36, heightOver36, heightOver8), new Coords(heightOver18, 0, 0 - heightOver6)),
            this.box(
            //"Foot.L",
            material, new Coords(heightOver36, heightOver12, heightOver36), new Coords(heightOver18, heightOver12, 0 - heightOver36)),
            this.box(
            //"Bicep.L",
            material, new Coords(heightOver36, heightOver36, heightOver12), new Coords(heightOver6, 0, 0 - heightOver2 - heightOver3)),
            this.box(
            //"Forearm.L",
            material, new Coords(heightOver36, heightOver36, heightOver12), new Coords(heightOver6, 0, 0 - heightOver2 - heightOver4 + heightOver8)),
            this.box(
            //"Thigh.R",
            material, new Coords(heightOver36, heightOver36, heightOver8), new Coords(0 - heightOver18, 0, 0 - heightOver2 + heightOver12)),
            this.box(
            //"Shin.R",
            material, new Coords(heightOver36, heightOver36, heightOver8), new Coords(0 - heightOver18, 0, 0 - heightOver6)),
            this.box(
            //"Foot.R",
            material, new Coords(heightOver36, heightOver12, heightOver36), new Coords(0 - heightOver18, heightOver12, 0 - heightOver36)),
            this.box(
            //"Bicep.R",
            material, new Coords(heightOver36, heightOver36, heightOver12), new Coords(0 - heightOver6, 0, 0 - heightOver2 - heightOver3)),
            this.box(
            //"Forearm.R",
            material, new Coords(heightOver36, heightOver36, heightOver12), new Coords(0 - heightOver6, 0, 0 - heightOver2 - heightOver4 + heightOver8)),
        ];
    ...
    grid(sizeInCells, cellSize, material) {
        ...
        var returnMesh = new Mesh(new Coords(0, 0, 0), // center
        ...
        if (material != null) {
            ...
            for (var y = 0; y < sizeInCells.y; y++) {
                for (var x = 0; x < sizeInCells.x; x++) {
                    var faceTexture = new MeshTexturedFaceTexture(material.name, textureUVs);
                    faceTextures.push(faceTexture);
                }
            }
            var returnMeshTextured = new MeshTextured(returnMesh, // geometry
    ...
    room(roomSize, neighborOffsets, connectedToNeighbors, materialWall, materialFloor, doorwayWidthScaleFactor, wallThickness) {
        ...
        for (var i = 0; i < meshesForRoom.length; i++) {
            ...
            var faceOrientation = new Orientation(faceNormal, faceOrientationDown);
            var faceTangent = faceOrientation.right;
            var faceDown = faceOrientation.down;
            mesh.transformFaceTextures(new Transform_Scale(new Coords(faceTangent.dotProduct(roomSize), faceDown.dotProduct(roomSize), 0).absolute().multiplyScalar(.2)));
        }
        var returnMesh = this.mergeMeshes(meshesForRoom, null);
        returnMesh.transform(new Transform_Scale(roomSize)).transform(new Transform_Translate(new Coords(0, 0, -roomSize.z)));
        return returnMesh;
    }
    ;
    room_Ceiling(material) {
        var returnMesh = this.unitSquare(material).transform(new Transform_Scale(new Coords(1, 1, -1))).transform(new Transform_Translate(new Coords(0, 0, -1))).transformFaceTextures(new Transform_Scale(new Coords(1, 1, 1).multiplyScalar(.2)));
        return returnMesh;
    }
    ;
    room_Floor(material) {
        var returnMesh = this.unitSquare(material).transform(new Transform_Translate(new Coords(0, 0, 1))).transformFaceTextures(new Transform_Scale(new Coords(1, 1, 1).multiplyScalar(9)));
        return returnMesh;
    }
    ;
    room_Wall(material) {
        ...
        var returnMeshTextured = new MeshTextured(returnMesh, [material], [
            new MeshTexturedFaceTexture(material.name, [
                new Coords(1, 0, 0),
                new Coords(0, 0, 0),
                new Coords(0, 1, 0),
                new Coords(1, 1, 0),
    ...
    room_WallWithDoorway(material, doorwayWidthScaleFactor, wallThickness) {
        ...
        [
            ...
            // top
            new Coords(-doorwayWidthHalf, -doorwayHeight, 0),
            new Coords(doorwayWidthHalf, -doorwayHeight, 0),
            new Coords(doorwayWidthHalf, -1, 0),
            new Coords(-doorwayWidthHalf, -1, 0),
            // left
            new Coords(-1, 1, 0),
            new Coords(-doorwayWidthHalf, 1, 0),
            ...
            new Coords(doorwayWidthHalf, -1, 0),
            // doorframe
            new Coords(-doorwayWidthHalf, 1, wt),
            new Coords(doorwayWidthHalf, 1, wt),
            new Coords(doorwayWidthHalf, -doorwayHeight, wt),
            new Coords(-doorwayWidthHalf, -doorwayHeight, wt),
        ], 
        ...
        [
            ...
            new Mesh_FaceBuilder([8, 9, 10, 11]),
            // doorframe
            new Mesh_FaceBuilder([5, 12, 15, 0]),
            new Mesh_FaceBuilder([1, 14, 13, 8]),
        ]);
        ...
        var transformScaleSides = new Transform_Scale(new Coords(doorwayWidthReversedHalf, .5, 0));
        var transformScaleTop = new Transform_Scale(new Coords(doorwayWidthHalf, doorwayHeightReversed, 0));
        var transformScaleSidesDoorframe = new Transform_Scale(new Coords(wallThickness, doorwayHeight, 0));
        var materialName = material.name;
        var faceTextures = [
            // wall
            // top
            new MeshTexturedFaceTexture(materialName, [
                new Coords(0, 1, 0),
                new Coords(1, 1, 0),
                new Coords(1, 0, 0),
                new Coords(0, 0, 0),
        ...
        var returnMeshTextured = new MeshTextured(returnMesh, [material], faceTextures, null).transformFaceTextures(new Transform_Scale(new Coords(1, 1, 1).multiplyScalar(2)));
        return returnMeshTextured;
    }
    ;
    unitCube(material) {
    ...
    unitCube_Geometry() {
        ...
        // vertexIndicesForFaces
        [
            new Mesh_FaceBuilder([7, 3, 0, 4]),
            new Mesh_FaceBuilder([5, 1, 2, 6]),
            new Mesh_FaceBuilder([4, 0, 1, 5]),
            new Mesh_FaceBuilder([6, 2, 3, 7]),
            new Mesh_FaceBuilder([0, 3, 2, 1]),
            new Mesh_FaceBuilder([5, 6, 7, 4]),
        ]);
        return returnMesh;
    }
    ;
    ...
    mergeMeshes(meshesToMerge, vertexGroupNames) {
        ...
        for (var m = 0; m < meshesToMerge.length; m++) {
            ...
            if (vertexGroupNames != null) {
                ...
                var vertexGroup = new VertexGroup(vertexGroupNames[m], vertexIndicesInVertexGroup);
        ...
        var returnMeshTextured = new MeshTextured(returnMesh, materialsMerged, faceTexturesMerged, vertexGroups);
        return returnMeshTextured;
    }
    ;
        ...
        if (doAnyEdgesCollideWithPlaneSoFar == true) {
            for (var i = 0; i < verticesInFacesDivided.length; i++) {
                ...
                if (verticesInFace.length > 2) {
                    var faceDivided = new FaceTextured(new Face(verticesInFace), faceToDivide.material);
