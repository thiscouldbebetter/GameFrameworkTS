...
class PlaceBuilderDemo_Items {
    ...
    armor() {
        ...
        var itemArmor = ItemDefn.fromNameEncumbranceValueCategoryNameUseAndVisual(itemArmorName, 50, 30, "Armor", (uwpe) => this.itemUseEquip(uwpe), itemArmorVisual);
        return itemArmor;
    }
    armorEnhanced() {
        ...
        if (this.parent.visualsHaveText) {
            itemArmorVisual.children.push(VisualOffset.fromOffsetAndChild(Coords.fromXY(0, 0 - this.entityDimension), VisualText.fromTextImmediateFontAndColor(itemArmorName, this.font, itemArmorColor)));
        }
        var itemArmor = ItemDefn.fromNameEncumbranceValueCategoryNameUseAndVisual(itemArmorName, 50, 30, "Armor", (uwpe) => this.itemUseEquip(uwpe), itemArmorVisual);
        return itemArmor;
    }
    arrow() {
        ...
        var itemArrowVisualShaft = new VisualLine(Coords.fromXY(-5, 0), Coords.fromXY(5, 0), Color.Instances().Brown, 1 // lineThickness
        );
        ...
        var itemArrowVisualTail = VisualPolygon.fromPathAndColorFill(pathTail, Color.Instances().White);
        ...
        if (this.parent.visualsHaveText) {
            itemArrowVisual.children.push(VisualOffset.fromOffsetAndChild(Coords.fromXY(0, 0 - this.entityDimension * 1.5), VisualText.fromTextImmediateFontAndColor(itemArrowName, this.font, itemArrowColor)));
        }
        var itemArrow = ItemDefn.fromNameEncumbranceValueAndVisual(itemArrowName, .05, 5, itemArrowVisual);
        return itemArrow;
    }
    bomb() {
        ...
        var itemBombVisual = VisualGroup.fromChildren([
            // fuse
            VisualOffset.fromOffsetAndChild(Coords.fromXY(0, -1).multiplyScalar(this.entityDimensionHalf), VisualRectangle.fromSizeAndColorFill(new Coords(.2, 1, 1).multiplyScalar(this.entityDimensionHalf), colors.Tan)),
            // body
            VisualCircle.fromRadiusAndColorFill(this.entityDimensionHalf, itemBombColor),
            // highlight
            VisualOffset.fromOffsetAndChild(Coords.fromXY(-this.entityDimensionHalf / 3, -this.entityDimensionHalf / 3), VisualCircle.fromRadiusAndColorFill(this.entityDimensionHalf * .3, colors.Blue))
        ]);
        if (this.parent.visualsHaveText) {
            itemBombVisual.children.push(VisualOffset.fromOffsetAndChild(Coords.fromXY(0, 0 - this.entityDimension * 2), VisualText.fromTextImmediateFontAndColor(itemBombName, this.font, itemBombColor)));
        }
        var itemBomb = ItemDefn.fromNameEncumbranceValueCategoryNameUseAndVisual(itemBombName, 5, 10, this.itemDefnCategoryNameWieldable, (uwpe) => this.itemUseEquip(uwpe), itemBombVisual);
        return itemBomb;
    }
    book() {
        ...
        var itemBookVisual = VisualGroup.fromChildren([
            ...
            VisualOffset.fromOffsetAndChild(Coords.fromXY(.4, 0).multiplyScalar(this.entityDimension), VisualRectangle.fromSizeAndColorFill(Coords.fromXY(.1, 1.1).multiplyScalar(this.entityDimension), colors.White))
        ]);
        if (this.parent.visualsHaveText) {
            itemBookVisual.children.push(VisualOffset.fromOffsetAndChild(Coords.fromXY(0, 0 - this.entityDimension * 1.5), VisualText.fromTextImmediateFontAndColor(itemBookName, this.font, itemBookColor)));
        }
        var itemBook = ItemDefn.fromNameEncumbranceValueCategoryNamesUseAndVisual(itemBookName, 1, 10, null, // categoryNames
        this.book_ItemBookUse, itemBookVisual);
        return itemBook;
    }
    book_ItemBookUse(uwpe) {
    ...
    bow() {
        ...
        var itemBowVisualString = VisualPolygon.fromPathAndColorFill(Path.fromPoints([
        ...
        if (this.parent.visualsHaveText) {
            itemBowVisual.children.push(VisualOffset.fromOffsetAndChild(Coords.fromXY(0, 0 - this.entityDimension * 2), VisualText.fromTextImmediateFontAndColor(itemBowName, this.font, itemBowColor)));
        }
        var itemBow = ItemDefn.fromNameEncumbranceValueCategoryNameUseAndVisual(itemBowName, 5, 100, this.itemDefnCategoryNameWieldable, (uwpe) => this.itemUseEquip(uwpe), itemBowVisual);
        return itemBow;
    }
    bread() {
        ...
        var itemBreadVisual = VisualGroup.fromChildren([
            ...
            itemBreadVisualCut,
            VisualOffset.fromOffsetAndChild(Coords.fromXY(-this.entityDimensionHalf * 0.75, 0), itemBreadVisualCut),
            VisualOffset.fromOffsetAndChild(Coords.fromXY(this.entityDimensionHalf * 0.75, 0), itemBreadVisualCut)
        ]);
        if (this.parent.visualsHaveText) {
            itemBreadVisual.children.push(VisualOffset.fromOffsetAndChild(Coords.fromXY(0, 0 - this.entityDimension * 1.5), VisualText.fromTextImmediateFontAndColor(itemBreadName, this.font, itemBreadColor)));
        }
        var itemBread = ItemDefn.fromNameEncumbranceValueCategoryNameUseAndVisual(itemBreadName, 1, 4, this.itemDefnCategoryNameConsumable, (uwpe) => // use
         {
            var entityUser = uwpe.entity;
    ...
    coin() {
        ...
        var itemCoinVisual = VisualGroup.fromChildren([
            ...
            VisualCircle.fromRadiusAndColorBorder(this.entityDimensionHalf * .75, colors.Gray)
        ]);
        if (this.parent.visualsHaveText) {
            itemCoinVisual.children.push(VisualOffset.fromOffsetAndChild(Coords.fromXY(0, 0 - this.entityDimension), VisualText.fromTextImmediateFontAndColor(itemCoinName, this.font, itemCoinColor)));
        }
        var itemCoin = ItemDefn.fromNameEncumbranceValueAndVisual(itemCoinName, .01, 1, itemCoinVisual);
        return itemCoin;
    }
    crystal() {
        ...
        var itemCrystal = ItemDefn.fromNameEncumbranceValueAndVisual(itemCrystalName, .1, 1, itemCrystalVisual);
        return itemCrystal;
    }
    doughnut() {
        ...
        */
        ...
        if (this.parent.visualsHaveText) {
            itemDoughnutVisualBody.children.push(VisualOffset.fromOffsetAndChild(Coords.fromXY(0, 0 - this.entityDimension * 2), VisualText.fromTextImmediateFontAndColor(itemDoughnutName, this.font, itemDoughnutColor)));
        }
        var itemDoughnut = ItemDefn.fromNameEncumbranceValueCategoryNameUseAndVisual(itemDoughnutName, 1, 4, this.itemDefnCategoryNameConsumable, (uwpe) => // use
         {
            var entityUser = uwpe.entity;
            var entityItem = uwpe.entity2;
    ...
    flower() {
        ...
        var itemFlowerVisual = VisualGroup.fromChildren([
            VisualOffset.fromOffsetAndChild(Coords.fromXY(.5, 1.75).multiplyScalar(this.entityDimensionHalf), new VisualArc(this.entityDimensionHalf * 2, // radiusOuter
            ...
            VisualPolygon.fromPathAndColorsFillAndBorder(Path.fromPoints([
                ...
                Coords.fromXY(0, -1),
                Coords.fromXY(.3, -.3)
            ]).transform(new Transform_Scale(Coords.ones().multiplyScalar(this.entityDimensionHalf))), colorFlower, colors.Red)
        ]);
        if (this.parent.visualsHaveText) {
            itemFlowerVisual.children.push(VisualOffset.fromOffsetAndChild(Coords.fromXY(0, 0 - this.entityDimensionHalf * 2), VisualText.fromTextImmediateFontAndColor(itemFlowerName, this.font, colorFlower)));
        }
        var itemFlower = ItemDefn.fromNameEncumbranceValueAndVisual(itemFlowerName, .01, 1, itemFlowerVisual);
        return itemFlower;
    }
    fruit() {
        ...
        var itemFruitVisual = VisualGroup.fromChildren([
            ...
            VisualOffset.fromOffsetAndChild(Coords.fromXY(-this.entityDimensionHalf / 2, -this.entityDimensionHalf / 2), VisualCircle.fromRadiusAndColorFill(this.entityDimensionHalf * .25, colors.White))
        ]);
        if (this.parent.visualsHaveText) {
            itemFruitVisual.children.push(VisualOffset.fromOffsetAndChild(Coords.fromXY(0, 0 - this.entityDimension), VisualText.fromTextImmediateFontAndColor(itemFruitName, this.font, itemFruitColor)));
        }
        var itemFruit = ItemDefn.fromNameEncumbranceValueCategoryNameUseAndVisual(itemFruitName, .25, 6, this.itemDefnCategoryNameConsumable, (uwpe) => // use
         {
            var entityUser = uwpe.entity;
            var entityItem = uwpe.entity2;
    ...
    grass() {
        ...
        if (this.parent.visualsHaveText) {
            itemGrassVisual.children.push(VisualOffset.fromOffsetAndChild(Coords.fromXY(0, 0 - this.entityDimensionHalf * 3), VisualText.fromTextImmediateFontAndColor(itemGrassName, this.font, Color.Instances().GreenDark)));
        }
        var itemGrass = ItemDefn.fromNameEncumbranceValueAndVisual(itemGrassName, .01, 1, itemGrassVisual);
        return itemGrass;
    }
    heart() {
        ...
        if (this.parent.visualsHaveText) {
            itemHeartVisual.children.push(VisualOffset.fromOffsetAndChild(Coords.fromXY(0, 0 - this.entityDimension * 1.5), VisualText.fromTextImmediateFontAndColor(itemHeartName, this.font, itemHeartColor)));
        }
        var itemHeartVisualShifted = VisualOffset.fromOffsetAndChild(Coords.fromXY(0, -entityDimensionQuarter), itemHeartVisual);
        var itemHeart = ItemDefn.fromNameEncumbranceValueAndVisual(itemHeartName, 10, 1, itemHeartVisualShifted);
        return itemHeart;
    }
    iron() {
        ...
        if (this.parent.visualsHaveText) {
            itemIronVisual.children.push(VisualOffset.fromOffsetAndChild(Coords.fromXY(0, 0 - this.entityDimension), VisualText.fromTextImmediateFontAndColor(itemIronName, this.font, itemIronColor)));
        }
        var itemIron = ItemDefn.fromNameEncumbranceValueAndVisual(itemIronName, 10, 5, itemIronVisual);
        return itemIron;
    }
    ironOre() {
        ...
        if (this.parent.visualsHaveText) {
            itemIronOreVisual.children.push(VisualOffset.fromOffsetAndChild(Coords.fromXY(0, 0 - this.entityDimension * 1.5), VisualText.fromTextImmediateFontAndColor(itemIronOreName, this.font, itemIronOreColor)));
        }
        var itemIronOre = ItemDefn.fromNameEncumbranceValueAndVisual(itemIronOreName, 10, 1, itemIronOreVisual);
        return itemIronOre;
    }
    key() {
        var itemKeyName = "Key";
        ...
        var itemKeyVisual = VisualGroup.fromChildren([
            ...
            itemKeyColor, null),
            VisualOffset.fromOffsetAndChild(Coords.fromXY(this.entityDimensionHalf, 0), new VisualPolars([
        ...
        if (this.parent.visualsHaveText) {
            itemKeyVisual.children.push(VisualOffset.fromOffsetAndChild(Coords.fromXY(0, 0 - this.entityDimension * 2), VisualText.fromTextImmediateFontAndColor(itemKeyName, this.font, itemKeyColor)));
        }
        var itemKey = ItemDefn.fromNameEncumbranceValueAndVisual(itemKeyName, .1, 5, itemKeyVisual);
        return itemKey;
    }
    log() {
        var itemLogName = "Log";
        ...
        var itemLogVisual = VisualGroup.fromChildren([
            VisualOffset.fromOffsetAndChild(Coords.fromXY(this.entityDimension, 0), VisualCircle.fromRadiusAndColorFill(this.entityDimensionHalf, itemLogColor)),
            VisualRectangle.fromSizeAndColorFill(Coords.fromXY(this.entityDimension * 2, this.entityDimension), itemLogColor),
            VisualOffset.fromOffsetAndChild(Coords.fromXY(-this.entityDimension, 0), VisualCircle.fromRadiusAndColorFill(this.entityDimensionHalf, Color.Instances().Tan))
        ]);
        if (this.parent.visualsHaveText) {
            itemLogVisual.children.push(VisualOffset.fromOffsetAndChild(Coords.fromXY(0, 0 - this.entityDimension), VisualText.fromTextImmediateFontAndColor(itemLogName, this.font, itemLogColor)));
        }
        var itemLog = ItemDefn.fromNameEncumbranceValueAndVisual(itemLogName, 10, 1, itemLogVisual);
        return itemLog;
    }
    meat() {
        ...
        if (this.parent.visualsHaveText) {
            itemMeatVisual.children.push(VisualOffset.fromOffsetAndChild(Coords.fromXY(0, 0 - this.entityDimension * 1.5), VisualText.fromTextImmediateFontAndColor(itemMeatName, this.font, itemMeatColor)));
        }
        var itemMeat = ItemDefn.fromNameEncumbranceValueCategoryNameUseAndVisual(itemMeatName, 1, 10, this.itemDefnCategoryNameConsumable, (uwpe) => // use
         {
            var entityUser = uwpe.entity;
            var entityItem = uwpe.entity2;
    ...
    medicine() {
        ...
        var itemMedicine = ItemDefn.fromNameEncumbranceValueCategoryNameUseAndVisual(itemMedicineName, 1, 10, this.itemDefnCategoryNameConsumable, (uwpe) => // use
         {
            var entityUser = uwpe.entity;
            var entityItem = uwpe.entity2;
    ...
    mushroom() {
        ...
        var itemMushroomVisual = VisualGroup.fromChildren([
            ...
            .5, // angleSpannedInTurns
            colorCap, null)),
            VisualOffset.fromOffsetAndChild(Coords.zeroes(), VisualRectangle.fromSizeAndColorFill(Coords.fromXY(this.entityDimensionHalf / 2, this.entityDimensionHalf), colorStem))
        ]);
        this.parent.textWithColorAddToVisual(itemMushroomName, colorCap, itemMushroomVisual);
        var itemMushroom = ItemDefn.fromNameEncumbranceValueAndVisual(itemMushroomName, .01, 1, itemMushroomVisual);
        return itemMushroom;
    }
    pick() {
        ...
        if (this.parent.visualsHaveText) {
            itemPickVisual.children.push(VisualOffset.fromOffsetAndChild(Coords.fromXY(0, 0 - this.entityDimension * 2), VisualText.fromTextImmediateFontAndColor(itemPickName, this.font, itemPickColor)));
        }
        var itemPick = ItemDefn.fromNameEncumbranceValueCategoryNameUseAndVisual(itemPickName, 1, 30, this.itemDefnCategoryNameWieldable, (uwpe) => this.itemUseEquip(uwpe), itemPickVisual);
        return itemPick;
    }
    potion() {
        ...
        if (this.parent.visualsHaveText) {
            itemPotionVisual.children.push(VisualOffset.fromOffsetAndChild(Coords.fromXY(0, 0 - this.entityDimension), VisualText.fromTextImmediateFontAndColor(itemPotionName, this.font, itemPotionColor)));
        }
        var itemPotion = ItemDefn.fromNameEncumbranceValueCategoryNameUseAndVisual(itemPotionName, 1, 10, this.itemDefnCategoryNameConsumable, (uwpe) => // use
         {
            var entityUser = uwpe.entity;
            var entityItem = uwpe.entity2;
            var effectToApply = Effect.Instances().Healing;
    ...
    shovel() {
        ...
        var itemShovel = ItemDefn.fromNameEncumbranceValueCategoryNameUseAndVisual(itemShovelName, 1, 30, this.itemDefnCategoryNameWieldable, (uwpe) => this.itemUseEquip(uwpe), itemShovelVisual);
        return itemShovel;
    }
    speedBoots() {
        ...
        if (this.parent.visualsHaveText) {
            itemSpeedBootsVisual.children.push(VisualOffset.fromOffsetAndChild(Coords.fromXY(0, 0 - this.entityDimension * 2), VisualText.fromTextImmediateFontAndColor(itemSpeedBootsName, this.font, itemAccessoryColor)));
        }
        var itemSpeedBoots = ItemDefn.fromNameEncumbranceValueCategoryNameUseAndVisual(itemSpeedBootsName, 10, 30, "Accessory", (uwpe) => this.itemUseEquip(uwpe), itemSpeedBootsVisual);
        return itemSpeedBoots;
    }
    sword() {
        var itemSwordVisual = this.sword_Visual(Color.Instances().GrayLight);
        var itemSword = ItemDefn.fromNameEncumbranceValueCategoryNameUseAndVisual("Sword", 10, 100, this.itemDefnCategoryNameWieldable, (uwpe) => this.itemUseEquip(uwpe), itemSwordVisual);
        return itemSword;
    }
    sword_Visual(bladeColor) {
        ...
        if (this.parent.visualsHaveText) {
            itemSwordVisual.children.push(VisualOffset.fromOffsetAndChild(Coords.fromXY(0, 0 - this.entityDimension * 2), VisualText.fromTextImmediateFontAndColor("Sword", this.font, bladeColor)));
        }
    ...
    swordCold() {
        ...
        var itemSword = ItemDefn.fromNameEncumbranceValueCategoryNameUseAndVisual("Sword" + damageTypeName, 10, 100, this.itemDefnCategoryNameWieldable, (uwpe) => this.itemUseEquip(uwpe), itemSwordVisual);
        return itemSword;
    }
    swordHeat() {
    ...
    toolset() {
        ...
        var itemToolsetVisual = VisualGroup.fromChildren([
            VisualOffset.fromOffsetAndChild(Coords.fromXY(0, this.entityDimension / 2), VisualRectangle.fromSizeAndColorFill(Coords.fromXY(this.entityDimension / 4, this.entityDimension), colors.Brown)),
        ...
        var itemToolset = ItemDefn.fromNameEncumbranceValueAndVisual(itemToolsetName, 1, 30, itemToolsetVisual);
        return itemToolset;
    }
    torch() {
        ...
        var itemTorchVisual = VisualGroup.fromChildren([
            VisualOffset.fromOffsetAndChild(Coords.create(), itemTorchVisualBody),
            VisualOffset.fromOffsetAndChild(Coords.fromXY(0, 0 - this.entityDimension * .75), itemTorchVisualHead),
            VisualOffset.fromOffsetAndChild(Coords.fromXY(0, 0 - this.entityDimension * .7), itemTorchVisualFlame)
        ]);
        this.parent.textWithColorAddToVisual(itemTorchName, itemTorchColor, itemTorchVisual);
        var itemTorch = ItemDefn.fromNameEncumbranceValueCategoryNamesUseAndVisual(itemTorchName, 1, 4, [
    ...
    weight() {
        ...
        var itemWeightVisual = VisualGroup.fromChildren([
            VisualOffset.fromOffsetAndChild(Coords.fromXY(0, -1).multiplyScalar(this.entityDimensionHalf), new VisualArc(this.entityDimensionHalf, // radiusOuter
            this.entityDimensionHalf / 2, // radiusInner
        ...
        var itemWeight = ItemDefn.fromNameEncumbranceValueAndVisual(itemWeightName, 2000, 5, itemWeightVisual);
        return itemWeight;
    }
}
